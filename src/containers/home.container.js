      ...
      <React.Fragment>
        <div className="text-center bg-light">
          <div className="col-md-12 p-lg-5 mx-auto my-5">
            ...
            <p className="lead font-weight-normal text-justify text-center">
              ...
              This is a kind of boilerplate. which one can use to kick start a react-redux app.
              <br />
        ...
        <div className="row">
          ...
          <div className="col-md-6">
            ...
            <p className="text-justify">
              This is a super lightweight virtual keyboard component built react with no other dependency. This component is very easy to use in a react application. This component
              themeing feature work is still in progress.
            </p>
            <p className="text-center">
